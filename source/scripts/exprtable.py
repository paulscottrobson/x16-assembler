...
c.scan()
c.makeTextTable(open("assembler/generated/operators.asm","w"))
c.makePrecedenceTable(open("assembler/generated/precedence.asm","w"))
c.makeVectorTable(open("assembler/generated/vectors.asm","w"))